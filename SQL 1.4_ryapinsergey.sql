...
CREATE TABLE IF NOT EXISTS
language_nationality (
language_id INTEGER REFERENCES language(language_id),
nationality_id INTEGER REFERENCES nationality(nationality_id),
CONSTRAINT language_nationality_unique PRIMARY KEY (language_id, nationality_id)
);
...
nationality_id INTEGER REFERENCES nationality(nationality_id),
CONSTRAINT country_nationality_unique PRIMARY KEY (country_id, nationality_id)
...
--Понимаю, что можно сделать вставку массивами, но пока не нашел как.
...
INSERT INTO film_new
VALUES
 ('Titanic', 2000, 2.7, 150);

--ЗАДАНИЕ №6
--Напишите SQL-запрос, который выведет все колонки из таблицы film_new, 
--а также новую вычисляемую колонку "длительность фильма в часах", округлённую до десятых
	
SELECT film_name, film_year, film_rental_rate, film_duration, round(CAST(film_duration AS numeric)/60, 1) duration_h
FROM film_new;
